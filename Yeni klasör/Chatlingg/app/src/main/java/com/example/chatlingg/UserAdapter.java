...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup jooparent, int viewType) {

        View view = LayoutInflater.from(context).inflate(R.layout.user_layout,jooparent,false);
